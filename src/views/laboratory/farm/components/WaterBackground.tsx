...
import styles from "../styles/WaterBackground.module.scss"

interface WaterBackgroundProps {
  width: number // Farm width in tiles
  height: number // Farm height in tiles
  hideWater?: boolean // Hide water animation
}
...
export const WaterBackground = ({
  ...
  return (
    <div
      className={`${styles.waterBackground} ${hideWater ? styles.hideWater : ""}`}
      style={{
        width: waterSizePx * 2,
        height: waterSizePx,
        left: -gridOffsetX,
